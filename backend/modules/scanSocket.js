...
const outputXmlPath = 'back-end/output/ports_output.xml';
const outputJsonPath = 'back-end/output/ports_output.json';
const nucleiTargetsPath = 'back-end/output/nuclei_targets.txt';
        ...
        fs.readFile(outputXmlPath, 'utf8', (err, data) => {
            ...
            xml2js.parseString(data, { explicitArray: false }, (parseErr, result) => {
                ...
                if (httpLikePorts.length > 0) {
                    ...
                    console.log('No HTTP services found to target.');
                }
            });
        });
    });
