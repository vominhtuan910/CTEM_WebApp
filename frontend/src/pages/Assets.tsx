  ...
  return (
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Dialog
        ...
        onClose={() =>
          !submitting && (setOpenDialog(null), setSelectedAsset(null))
        }
        maxWidth="md"
        fullWidth
        PaperProps={{
      ...
      >
        ...
        <DialogActions sx={dialogStyles.actions}>
          ...
          <Button
            ...
            disabled={
              !exportDialog.options.services &&
              !exportDialog.options.applications
            }
            sx={{
              borderRadius: 2,
              textTransform: "none",
